 ...
 */
echo "<link rel='stylesheet' href='/../wcode_clinic/fullstackphp/fsphp.css'/>",
...
/**
 * [ Debug sessions ] Cria uma linha de sessão para exemplos
 * @var $color = red | green | yellow | blue
 * @var line = __LINE__
 */
function fullStackPHPClassSession($session, $line, $color = null)
{
    $line = (!empty($line) ? " <span class='line-sessions'>| Linha {$line}</span>" : "");
